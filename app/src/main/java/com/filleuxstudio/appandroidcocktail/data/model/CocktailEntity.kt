...
// Importation des annotations de Room pour définir la classe comme une entité et ses colonnes
import androidx.room.ColumnInfo
import androidx.room.Entity
import androidx.room.PrimaryKey

// Annotation pour marquer la classe comme une entité de base de données Room, avec `tableName` définissant le nom de la table.
@Entity(tableName = "cocktail")
data class CocktailEntity(
    // Chaque champ représente une colonne de la table `cocktail`.
    // Annotation @ColumnInfo pour spécifier un nom de colonne si différent du nom de la propriété Kotlin.
